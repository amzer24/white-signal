...
static func rooms() -> Dictionary:
    ...
    var district := {
        ...
        "stand_trial":{"title":"FRACTURE TRIAL", "spawn":Vector2(40,217),"platforms":[Rect2(0,224,95,46),Rect2(390,224,90,46)],"exits":[["conductor",Vector2(27,217),"RESERVOIR RETURN"]],"actions":[["stand_archive",Vector2(434,217),"OPERATOR ARCHIVE"]]},
    ...
    var goals := {
        ...
        "stand_trial":"OPTIONAL ARCHIVE . CRACKED PLATFORMS FALL"
    }
    for id in district:
