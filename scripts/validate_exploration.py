...
TESTS = (
    "extras_menu_test", "shutter_routes_test", "opening_playthrough_test", "wire_first_playthrough_test",
    "fourth_route_test", "fracture_routes_test", "menu_transition_test", "new_journey_test", "map_revisit_test",
